...
>(({ className, variant = "ghost", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute md:h-8 md:w-8 h-4 w-4 rounded-full",
        orientation === "horizontal"
          ? "md:-left-12 -left-3 top-1/2 -translate-y-1/2"
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute md:h-8 md:w-8 h-4 w-4 rounded-full",
        orientation === "horizontal"
          ? "md:-right-12 -right-5 top-1/2 -translate-y-1/2"
          : "md:-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
