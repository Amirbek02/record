...
import StudentsCardAccordion from "../students-info/StudentsCardAccordion";
import StudentsAdditionalTest from '../students-info/StudentsAdditionalTest';
import PayProfile from './PayProfile';

const PayStudentsList = () => {
  const students = [
...
export default PayStudentsList;
