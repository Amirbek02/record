  ...
  const teamMembers = [
    {
      ...
      customClass:
        "absolute mt-[40px] w-[133px] h-[133px] sm:left-[200px] left-[55px] top-[-70px] md:left-[250px] lg:left-[240px] md:h-[200px] md:w-[200px] lg:w-[160px] lg:h-[160px] lg:top-[-100px] md:top-[-150px] lg:left-[160px] mb-[20px]",
    },
    {
      id: 2,
      name: "Адыл",
      ...
      customClass:
        "absolute mt-[40px] w-[132px] h-[130px] sm:h-[200px] sm:w-[200px] right-[0px] top-[-90px] md:w-[202px] md:h-[200px]  lg:w-[202px] lg:h-[200px] lg:top-[-70px] lg:right-[30px]",
    },
    {
      id: 3,
      ...
      extraContent: (
        <div className="relative mb-[30px] w-[30px]  sm:z-[9999] flex items-center bg-opacity-60  bg-[#C9D3E7] rounded-[8px] h-[26px] px-2  text-white  z-100">
          <Image
            src="/images/AboutUs/Group58.png"
            alt="icon"
            width={18}
    ...
    },
    {
      ...
      customClass:
        "absolute bottom-[-60px] right-[0px] w-[196px] h-[180px] md:w-[240px] md:h-[226px] sm:bottom-[10px] lg:w-[240px] lg:h-[226px] lg:bottom-[20px] lg:right-[30px]",
    },
  ];
        ...
        <div>
          <section className="relative max-w-7xl mx-auto ">
            ...
            <div className="container    lg:mx-auto  lg:px-4 flex flex-col gap-4 sm:gap-[30px] lg:gap-8 lg:flex-row ">
              ...
              <div className="relative w-[360px] h-[447px] rounded-xl mt-[60px] sm:w-full lg:max-w-[700px] lg:h-[447px] bg-gray-100  py-6 px-4 order-2 lg:order-1">
                ...
                <div className=" left-0 flex gap-5 sm:mt-6 ">
                  ...
                  <div className="">
                    <Link
                      className="border rounded-[20px] bottom-[160px] lg:bottom-2 md:bottom-2 md:left-52   lg:left-52  absolute  p-2 pl-7 bg-emerald-500 lg:bg-blue-800 hover:bg-white  text-white hover:text-black font-bold text-[22px] pr-7"
                      href="/"
                    >
                      Чалуу
                    </Link>
          ...
          <div className="container       flex flex-col gap-4 sm:gap-[30px]  ">
            ...
            <div className="relative w-auto h-[447px] rounded-xl mt-[60px] sm:w-full  bg-gray-100  py-6 px-4 order-2">
              ...
              <div className=" left-0 flex gap-5 sm:mt-6 ">
                ...
                <div className="">
                  <Link
                    className="border  rounded-[20px] right-2 bottom-[170px] sm:right-2 md:w-[130px] sm:bottom-[200px] md:bottom-2 md:left-52  absolute  p-2 pl-7 bg-emerald-500 hover:bg-white  text-white hover:text-black font-bold md:text-[22px] text-[14px] sm:text-[22px] pr-7"
                    href="/"
                  >
                    Чалуу
                  </Link>
