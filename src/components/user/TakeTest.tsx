    ...
    <div>
      <div className="flex justify-center items-center flex-col px-[15px]  small:px-[35px] pb-[120px] pt-[40px] ">
        ...
        <div className="pt-[24px] pb-[60px]">
          ...
          <p className="font-montserrat text-[#4c4c4c] text-[28px] font-[700] leading-[80%] tracking-[0.2px] hidden lg:block">
            Негизги тест
          </p>
        ...
        <CustomButton
          title="Тестти баштоо"
          containerStyles="h-[40px] small:h-[50px] w-[220px] lg:w-[185px] small:w-[360px] rounded-[10px] lg:self-end "
