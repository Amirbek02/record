...
const MobilePaymentCards = ({
  ...
  return (
    <div className="w-[351px] h-auto bg-cover bg-center md:hidden cursor-pointer" onClick={onClick}>
...
const PaymentCards = () => {
  ...
  return (
    <div className="p-4 flex flex-col gap-10">
      <H1Text />
      <h1 className="font-semibold text-[28px] text-darkGrey pb-5 md:hidden text-center">Төлөм</h1>
