...
const Header = () => {
  ...
  return (
    <div className="w-full max-w-[] sticky z-50 top-0 bg-[#fff]">
            ...
            <aside
              ...
              <div className="flex flex-col items-center justify-end h-full">
                <Link href="/sign-in" className="mb-4">
                  <button className="md:py-[10px] md:px-[13px] w-44 h-10  lg:pt-[14.93px] lg:pb-[15.87px] lg:pl-[31px] lg:pr-[25px] font-medium text-[16px] lg:text-[22px] border-[1.5px] border-[black]  rounded-[80px] text-[#6C6C6C]">
                    Кирүү
                  </button>
                </Link>
                <Link href="/sign-up">
                  <button className="md:py-[10px] md:px-[13px] w-44 h-10 mb-20  lg:pt-[14.93px] lg:pb-[15.87px] lg:pl-[31px] lg:pr-[25px] font-medium text-[16px] lg:text-[22px]  rounded-[80px] bg-[#2E3095] text-[#fff]">
                    Катталуу
                  </button>
                </Link>
              </div>
