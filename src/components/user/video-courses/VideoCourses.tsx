  ...
  return (
    <div className="h-[1340px] pl-2 md:pl-0 pb-10 md:pb-0">
      <Carousel
        ...
        <h1 className="md:text-[20px] text-[14px] text-[#2E3095] font-bold md:mt-20 md:mb-6 mb-4 mt-10 ">
          1-бөлүм. Математика{' '}
        </h1>
      ...
      <Carousel
        ...
        <h1 className="md:text-[20px] text-[14px] text-[#2E3095] font-bold md:mt-10 md:mb-6 mb-4 mt-4 ">
          2-бөлүм. Математика{' '}
        </h1>
        <CarouselContent className="ml-0 flex">
          {videoCourses.map((item) => (
      ...
      <Carousel
        ...
        className="relative md:w-[60%] w-[100%] max-w-[1440px] overflow-hidden md:mx-10 mx-1">
        <h1 className="md:text-[20px] text-[14px] text-[#2E3095] font-bold md:mt-10 mt-4 md:mb-6 mb-4 mt-4 ">
          1-бөлүм. Кыргыз тил{' '}
        </h1>
        <CarouselContent className="ml-0 flex">
          {videoCourses.map((item) => (
