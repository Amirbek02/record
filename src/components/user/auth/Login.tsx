    ...
    <div className="flex justify-center items-center flex-col w-[360px] mm:w-auto">
      ...
      <FormProvider {...form}>
        ...
        >
          <div className="flex flex-col items-start">
            ...
            <div className="relative w-[270px] mm:w-[356px] xl:w-[500px]">
              ...
              <button
                ...
                className="absolute top-[46px] right-[25px] transform -translate-y-1/2 self-center text-[rgba(0,0,0,0.44)] w-[20px] h-[14px]"
              >
                {showPassword ? (
          ...
          {error && (
            <h3 className="font-montserrat text-[12px] text-red-500 mb-[20px]">
              {error}
            </h3>
          )}
